...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sagaHelpers__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scheduler__ = __webpack_require__(11);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var _tokenAuth = __webpack_require__(7);
    ...
    return regeneratorRuntime.wrap(function saga$(_context2) {
        while (1) {
            switch (_context2.prev = _context2.next) {
                case 0:
                    handleLogin = /*#__PURE__*/regeneratorRuntime.mark(function handleLogin(action) {
                        var _ref2, user, _accessToken, _refreshToken;

                        return regeneratorRuntime.wrap(function handleLogin$(_context) {
                            while (1) {
...
var processTokenRefresh = /*#__PURE__*/regeneratorRuntime.mark(function processTokenRefresh() {
    var rToken, tokens;
    return regeneratorRuntime.wrap(function processTokenRefresh$(_context3) {
        while (1) {
...
var authorizedFn = /*#__PURE__*/exports.authorizedFn = regeneratorRuntime.mark(function authorizedFn(detectShouldRefresh, fn) {
    var processFn, result;
    return regeneratorRuntime.wrap(function authorizedFn$(_context5) {
        while (1) {
            switch (_context5.prev = _context5.next) {
                case 0:
                    processFn = /*#__PURE__*/regeneratorRuntime.mark(function processFn() {
                        var aToken, rToken, user;
                        return regeneratorRuntime.wrap(function processFn$(_context4) {
                            while (1) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__takeEvery__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__takeLatest__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__throttle__ = __webpack_require__(13);
