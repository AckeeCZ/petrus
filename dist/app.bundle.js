...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sagaHelpers__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scheduler__ = __webpack_require__(52);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var _tokenAuth = __webpack_require__(16);

var _tokenAuth2 = _interopRequireDefault(_tokenAuth);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _tokenAuth2.default;
...
exports.reducer = exports.authorizedFn = exports.saga = exports.logout = exports.setLoginError = exports.login = exports.configure = exports.isLoggingIn = exports.loginErrors = undefined;
...
var SET_AUTH_LOGIN_ERRORS = 'SET_AUTH_LOGIN_ERRORS';
...
var AUTH_REFRESH_TOKEN_FAILED = 'AUTH_REFRESH_TOKEN_FAILED';
var AUTH_REFRESH_TOKEN_COMPLETED = 'AUTH_REFRESH_TOKEN_COMPLETED';
...
var setLoginError = exports.setLoginError = function setLoginError(e) {
    return {
...
var tokenRefreshStopped = function tokenRefreshStopped() {
    return {
            ...
            switch (_context2.prev = _context2.next) {
                case 0:
                    handleLogin = /*#__PURE__*/_regenerator2.default.mark(function handleLogin(action) {
                        var _ref2, user, _accessToken, _refreshToken;
                            ...
                            while (1) {
                                switch (_context.prev = _context.next) {
                                    ...
                                    case 3:
                                        _ref2 = _context.sent;
                                        user = _ref2.user;
                                        _accessToken = _ref2.accessToken;
                                        _refreshToken = _ref2.refreshToken;
                                        ...
                                        _context.next = 10;
                                        return (0, _effects.put)(setAuthUser(user));

                                    case 10:
                                        _context.next = 12;
                                        return (0, _effects.put)(setTokens({ accessToken: _accessToken, refreshToken: _refreshToken }));
                                    ...
                                    case 14:
                                        ...
                                        _context.next = 18;
                                        return (0, _effects.put)(setLoginError(_context.t0));
...
var processTokenRefresh = /*#__PURE__*/_regenerator2.default.mark(function processTokenRefresh() {
        ...
        while (1) {
            switch (_context3.prev = _context3.next) {
                ...
                case 21:
                    _context3.prev = 21;
                    _context3.next = 24;
                    return (0, _effects.put)(tokenRefreshStopped());
    ...
    }, processTokenRefresh, this, [[5, 15, 21, 25]]);
});
        ...
        while (1) {
            switch (_context5.prev = _context5.next) {
                ...
                case 3:
                    ...
                    _context5.next = 6;
                    return (0, _effects.take)(AUTH_REFRESH_TOKEN_COMPLETED);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__takeEvery__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__takeLatest__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__throttle__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fsmIterator__ = __webpack_require__(6);
